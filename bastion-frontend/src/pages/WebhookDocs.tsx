      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">
            Receive asynchronous notifications from Bastion about claims, status
            updates, and user risk changes.
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <section id="introduction" className="scroll-mt-24">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
                <div className="md:col-span-5 space-y-3">
                  ...
                  <p>
                    Bastion uses webhooks to notify your system about important
                    events, such as claim creation, status transitions (e.g.,
                    PENDING → APPROVED), or user risk score changes. After you
                    register an endpoint, Bastion delivers JSON payloads via
                    HTTPS POST.
                  </p>
                  <ul className="list-disc pl-5">
                    <li>
                      Deliveries are retried with exponential backoff on failure
                      (non-2xx)
                    </li>
                    <li>
                      Endpoints are isolated by environment (Live vs Test)
                    </li>
                ...
                <aside className="md:col-span-7 md:pl-6 md:sticky md:top-16">
                  <div className="rounded-lg border bg-card p-4 space-y-3">
                    <div className="text-foreground font-medium">
                      Example delivery (claim.created)
                    </div>
                    <CodeBlock
                      lang="json"
                      code={`{
            ...
            <section id="signing" className="scroll-mt-24">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
                <div className="md:col-span-5 space-y-3">
                  ...
                  <p>
                    Each delivery includes an <code>X-Bastion-Signature</code>{" "}
                    header. Verify the payload using your endpoint's Signing
...
`}
                      ...
                      <TabsContent value="js" className="mt-3">
                        <CodeBlock
                          lang="javascript"
                          code={`function verify(signature, body, secret) {
  ...
  return mac === signature;
                      ...
                      <TabsContent value="bash" className="mt-3">
                        <CodeBlock
                          lang="bash"
                          code={`curl -X POST https://your.endpoint/webhooks \\
  -H "X-Bastion-Signature: <signature>" \\
            ...
            <section id="events" className="scroll-mt-24">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
                <div className="md:col-span-5 space-y-3">
                  ...
                  <ul className="list-disc pl-5">
                    <li>
                      <code>claim.created</code> — New claim submitted
                    </li>
                    <li>
                      <code>claim.updated</code> — Claim status or data changed
                    </li>
                    <li>
                      <code>user.risk_changed</code> — User-level risk score
                      updated
                    </li>
                  </ul>
                </div>
            ...
            <section id="manage" className="scroll-mt-24">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
                <div className="md:col-span-5 space-y-3">
                  ...
                  <p>
                    Create and manage endpoints in the Dashboard under{" "}
                    <em>Developer API → Webhooks</em>. Separate Live and Test
                    endpoints to avoid mixing data.
                  </p>
                </div>
                <aside className="md:col-span-7 md:pl-6 md:sticky md:top-16">
                  <div className="rounded-lg border bg-card p-4">
                    <Tabs defaultValue="create">
                      ...
                      <TabsContent value="create" className="mt-3">
                        <CodeBlock
                          lang="bash"
                          code={`curl -X POST https://api.bastion.com/v1/webhooks \\
  -H "X-API-Key: <YOUR_API_KEY>" \\
  -H "Content-Type: application/json" \\
  -d '{"url":"https://example.com/webhooks/bastion","env":"live"}'`}
                        />
                      </TabsContent>
                      <TabsContent value="list" className="mt-3">
                        <CodeBlock
                          lang="bash"
                          code={`curl -X GET https://api.bastion.com/v1/webhooks \\
  -H "X-API-Key: <YOUR_API_KEY>"`}
                        />
                      </TabsContent>
                      <TabsContent value="delete" className="mt-3">
                        <CodeBlock
                          lang="bash"
                          code={`curl -X DELETE https://api.bastion.com/v1/webhooks/{webhook_id} \\
  -H "X-API-Key: <YOUR_API_KEY>"`}
                        />
                      </TabsContent>
                    </Tabs>
            ...
            <section id="retries" className="scroll-mt-24">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
                <div className="md:col-span-5 space-y-3">
                  ...
                  <p>
                    Bastion retries deliveries on failure (non-2xx) with
                    exponential backoff for up to 24 hours. Ensure your endpoint
                    responds quickly (under 5s). You can replay events from the
                    Dashboard if needed.
                  </p>
                </div>
                <aside className="md:col-span-7 md:pl-6 md:sticky md:top-16">
                  <div className="rounded-lg border bg-card p-4">
                    ...
                    <CodeBlock
                      lang="bash"
                      code={`# Respond with 2xx quickly after enqueueing async work
HTTP/1.1 200 OK`}
                    />
                  </div>
                </aside>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
                <div className="md:col-span-5 space-y-3">
                  ...
                  <ul className="list-disc pl-5">
                    ...
                    <li>
                      Use allowlists or auth on your endpoints where possible
                    </li>
                  </ul>
                </div>
                <aside className="md:col-span-7 md:pl-6 md:sticky md:top-16">
                  <div className="rounded-lg border bg-card p-4">
                    ...
                    <CodeBlock
                      lang="bash"
                      code={`X-Bastion-Signature: <hex-hmac-sha256>`}
                    />
                  </div>
                </aside>
              </div>
